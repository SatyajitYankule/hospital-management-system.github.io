    ...
    <section class="intro">
        <div class="bg-image " style="background-image: url('https://mdbootstrap.com/img/Photos/new-templates/tables/img4.jpg'); background-attachment:fixed; min-height:100%">
            <div class="mask  h-100" style="background-color: rgba(25, 185, 234,.25);">
                ...
                <h1 class="text-center pt-2 text-capitalize text-white">View all Patients list</h1>
                <hr class="w-25 mx-auto text-white">
                <div class="container py-5 pt-3 align-item-center">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="add-medicine.php?id=<?php echo $result['id']; ?>" class="btn btn-outline-primary">Add Medicine</a></td>
                                                    </tr>
