...
<head>
    ...
    <style>
        ...
        .intro {
            height: 100%;
            background-image: linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url(../images/hospital1.jpg);
            color: #fff;
        }
...
<body>
    <section class="intro">
        <!-- <div class="bg-image h-100" style="background-image: url('https://mdbootstrap.com/img/Photos/new-templates/tables/img2.jpg'); background-attachment:fixed; min-height:100%" > -->
            ...
            <nav class="navbar navbar-expand-lg navbar-light nav-navbar ">
                ...
                <h1 class="text-center text-capitalize pt-3">Medicine List</h1>
