...
$selectUpdateMedicine = " SELECT * FROM medicine_list WHERE id='$id'";
$medicineQuery = mysqli_query($con, $selectUpdateMedicine);
$fetched = mysqli_fetch_assoc($medicineQuery);
...
if (isset($_POST['add'])) {
    ...
    if (!empty($medicine_name) && !empty($price)) {
        ...
        $selectUpdateMedicine = "UPDATE medicine_list SET medicine_name='$medicine_name', price='$price' WHERE id='$id'";
        $Qry = mysqli_query($con, $selectUpdateMedicine);
        if ($Qry) {
            
            header("location:manage-medicines.php");
        } else {
            $msg = '<div class="alert alert-danger alert-dismissible fade show text-center" role="alert">
        <strong> Medicine Not Updated !</strong>
                            ...
                            <div class="medicine-form mt-3">
                                <div class="row g-3 pb-3 align-items-end">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Medicine_name" value="<?php echo $fetched['medicine_name']; ?>" name="medicine_name">
                                    </div>

                                    <div class="col-12">

                                        <input type="text" class="form-control" placeholder="Medicine_Price" value="<?php echo $fetched['price'] ?>" name="price">
                                    </div>
